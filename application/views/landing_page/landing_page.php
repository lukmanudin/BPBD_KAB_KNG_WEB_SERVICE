    ...
    <body>
                            ...
                            <div class="row">
                                <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                                    <div class="navbar-header">
                                        ...
                                        <a href="#top" class="navbar-brand">BPBD Kab.Kuningan</a>
                                        <div id="main-nav" class="collapse navbar-collapse">
                                            <ul class="menu-first nav navbar-nav" style="margin-right: 20px;">
                                                <li class="active"><a href="#">Beranda</a></li>
                                                <li><a href="#about">Tentang BPBD</a></li>
                                                <li><a href="#peringatan_dini">Peringatan Dini</a></li>
                                                <li><a href="#info_bencana">Info Bencana</a></li>
                                                <li><a href="#laporan_masyarakat">Laporan Masyarakat</a></li>                               
                                            </ul>                                    
                                        </div> 
                                    </div>
                                </nav>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner-content">
                            <h6>Selamat datang di mobile apps</h6>
                            <h2>BPBD</h2>
                            <h6>Kabupaten Kuningan</h6>
                            <!-- <ul class="buttons">
                                <li>
        ...
        <section id="about" class="page-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="service-item first-service"  style="min-height:780px;">
                            <div class="icon">
                                <img src="<?php echo base_url();?>assets/landing_page/img/first-service-icon.png" alt="">
                            </div>
                            <h4>Tentang BPBD Kuningan</h4>
                            <p><b>Kewajiban Pemerintah</b>
                            <p>Sebagaimana tersurat dalam Undang-Undang Dasar 1945 yang ditegaskan kembali dalam Undang-Undang Nomor 24 Tahun 2007 tentang Penanggulangan Bencana, menyatakan bahwa NKRI  bertanggung jawab melindungi segenap bangsa Indonesia dan seluruh tumpah darah Indonesia untuk memberikan perlindunganterhadap kehidupan dan penghidupan, yang termaksud didalamnya adalah perlindungan atas terjadinya bencana
                            <br><br><p><b>Tingkat Kerawanan</b>
                            <p>Mencermati kondisi geografis, geologis, hidrologis, dan demografis, pada kenyataannya Kabupaten Kuningan memiliki tingkat kerawanan tinggi terhadap terjadinya bencana, ke 11 diantara 26 kabupaten/kota di Jawa Barat dan ke 76 di tingkat nasional(data tahun 2010), baik yang disebabkan oleh faktor alam, faktor non alam maupun faktor manusia
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-item third-service" style="min-height:780px;">
                            <div class="icon">
                                <img src="<?php echo base_url();?>assets/landing_page/img/third-service-icon.png" alt="">
                            </div>
                            <h4>Visi</h4>
                            <p>Terbangkitkannya Kesadaran dan Ketangguhan Masyarakat dalam Penanggulangan Bencana Tahun 2018</p>
                            <h4>Misi </h4>
                            <p>* Melindungi masyarakat dari ancaman bencana melalui pengurangan risiko bencana.
                            <p>* Membangun sistem penanggulangan bencana yang cepat, tepat dan akurat.
                            <p>* Menyelenggarakan Penanggulangan Bencana secara terencana, terpadu, terkoordinasi dan menyeluruh.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="owl-portfolio" class="owl-carousel owl-theme imageGallery1">
                        <div class="item">
                            <div class="portfolio-item">
                                <a href="<?php echo base_url();?>assets/landing_page/img/first-portfolio-big.jpg" title=""><img src="<?php echo base_url();?>assets/landing_page/img/first-portfolio-item.jpg" alt="Gallery image 1" /></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="portfolio-item">
                                <a href="<?php echo base_url();?>assets/landing_page/img/second-portfolio-big.jpg" title=""><img src="<?php echo base_url();?>assets/landing_page/img/second-portfolio-item.jpg" alt="Gallery image 1" /></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="portfolio-item">
                                <a href="<?php echo base_url();?>assets/landing_page/img/third-portfolio-big.jpg" title=""><img src="<?php echo base_url();?>assets/landing_page/img/third-portfolio-item.jpg" alt="Gallery image 1" /></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="portfolio-item">
                                <a href="<?php echo base_url();?>assets/landing_page/img/fourth-portfolio-big.jpg" title=""><img src="<?php echo base_url();?>assets/landing_page/img/fourth-portfolio-item.jpg" alt="Gallery image 1" /></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="portfolio-item">
                                <a href="<?php echo base_url();?>assets/landing_page/img/first-portfolio-big.jpg" data-lightbox="image-1"><img src="<?php echo base_url();?>assets/landing_page/img/first-portfolio-item.jpg"></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="portfolio-item">
                                ...
                                <ul class="tabs clearfix" data-tabgroup="second-tab-group">
                                    <li class="col-md-15 col-sm-12 col-xs-12">
                                        <a href="#unique" class="active">
                                            <div class="list-item">
                                                <div class="icon">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/first-list-icon.png" alt="">
                                                </div>
                                    ...
                                    <li class="col-md-15 col-sm-12 col-xs-12">
                                        <a href="#theme">
                                            <div class="list-item">
                                                <div class="icon">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/second-list-icon.png" alt="">
                                                </div>
                                                <h4>Rawan Kebakaran Hutan</h4>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="col-md-15 col-sm-12 col-xs-12">
                                        <a href="#translation">
                                            <div class="list-item">
                                                <div class="icon">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/third-list-icon.png" alt="">
                                                </div>
                                                <h4>Rawan Banjir</h4>
                                            </div>
                                        </a>
                                    ...
                                    <li class="col-md-15 col-sm-12 col-xs-12">
                                        <a href="#event">
                                            <div class="list-item">
                                                <div class="icon">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/fourth-list-icon.png" alt="">
                                                </div>
                                                <h4>Rawan Tanah Longsor</h4>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="col-md-15 col-sm-12 col-xs-12">
                                        <a href="#photo">
                                            <div class="list-item">
                                                <div class="icon">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/fivth-list-icon.png" alt="">
                                                </div>
                                                <h4>Rawan Kekeringan</h4>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="tab-content-services">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-image">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/right-side-image_1.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="theme">
                                    <div class="row">
                                        <div class="tab-content-services">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-image">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/right-side-image_2.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="translation">
                                    <div class="row">
                                        <div class="tab-content-services">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-image">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/right-side-image_3.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="event">
                                    <div class="row">
                                        <div class="tab-content-services">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-image">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/right-side-image_4.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="photo">
                                    <div class="row">
                                        <div class="tab-content-services">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-image">
                                                    <img src="<?php echo base_url();?>assets/landing_page/img/right-side-image_5.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="col-md-6">
                            <div id="first-tab-group" class="tabgroup">
                                <div id="tab1">
                                    <img src="<?php echo base_url();?>assets/landing_page/img/blog-post-1.jpg" alt="">
                                ...
                                <div id="tab2">
                                    <img src="<?php echo base_url();?>assets/landing_page/img/blog-post-2.jpg" alt="">
                                    <div class="text-content">
                                ...
                                <div id="tab3">
                                    <img src="<?php echo base_url();?>assets/landing_page/img/blog-post-3.jpg" alt="">
                                    <div class="text-content">
                                ...
                                <div id="tab4">
                                    <img src="<?php echo base_url();?>assets/landing_page/img/blog-post-4.jpg" alt="">
                                    <div class="text-content">
                                ...
                                <div id="tab5">
                                    <img src="<?php echo base_url();?>assets/landing_page/img/blog-post-5.jpg" alt="">
                                    <div class="text-content">
        ...
        <script src="<?php echo base_url();?>assets/landing_page/js/vendor/jquery.gmap3.min.js"></script>
        ...
        //----
        $.ajax({
            url: "<?php echo site_url(); ?>/api/landing_page_web/",
            type: 'GET',
