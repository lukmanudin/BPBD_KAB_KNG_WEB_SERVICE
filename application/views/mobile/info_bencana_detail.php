                            ...
                            <div id="first-tab-group" class="tabgroup">
                                <div id="tab1">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <?php echo $page_content[0]->dampak; ?>
                                        </p>

                                        <p>
                                        <label>Kerugian Material</label><br>
                                        <?php echo $page_content[0]->kerugian_material; ?>
                                        </p>

                                        <p>
                                        <label>Korban Jiwa</label><br>
                                        <?php echo $page_content[0]->korban_jiwa; ?>
                                        </p>  
                                        ...
                                        <?php echo $page_content[0]->penanganan; ?>
                                        </p>
                                    
                                        <p>
                                        <label>Kebutuhan / Darurat</label><br>
                                        <?php echo $page_content[0]->kebutuhan_darurat; ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
