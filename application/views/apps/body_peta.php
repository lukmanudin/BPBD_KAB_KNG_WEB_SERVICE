        ...
        <div class="col-lg-12" id="notifikasi_bar">  
          ...
          <div class="table-responsive">
            <table class="table table-striped table-consensed">
              ...
              <tbody id="tabel_data">
                <tr>
                  <td colspan="5">Tidak ada peta tersimpan di database!</td>
                </tr>
              </tbody>
              <tfoot>
                <tr>
            ...
            $(document).ready(function(){
              $.ajax({
                url: "<?php echo site_url(); ?>/api/peta/",
                type: 'GET',
            ...
            function edit_data(id){
              window.location = "<?php echo site_url(); ?>/apps/peta/edit/" + id + "/";
            }
            ...
            function delete_data(id){
              ...
              if(del){
                $.ajax({
                    url: "<?php echo site_url(); ?>/api/peta_delete/" + id + "/",
                    type: 'GET',
                    dataType : 'json',
                    success: function(response) {
